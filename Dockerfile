FROM arm64v8/nginx:1.15.5

MAINTAINER Khromium "devs@outlook.jp"

WORKDIR /root

ENV DOCKER_GEN_VERSION 0.7.4

ADD https://github.com/just-containers/s6-overlay/releases/download/v1.21.7.0/s6-overlay-aarch64.tar.gz /tmp/
...
RUN tar xzf /tmp/s6-overlay-aarch64.tar.gz -C / &&\
    ...
    rm /tmp/s6-overlay-aarch64.tar.gz && \
